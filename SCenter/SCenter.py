...
def maj(latest_version):
    ...
    text_version = tk.Label(window, text=f"La version v{latest_version} est disponible !", font=("Arial", 14))
    text_version.pack(pady=20)

    text_version2 = tk.Label(window, text=f"Vous avez la version v{version_installee}.", font=("Arial", 14))
    text_version2.pack(pady=20)
